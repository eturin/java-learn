...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.than(createDigest).than(wrapInRequestTag);
    ...
    interface RequestHandler {
        ...
        default RequestHandler than(RequestHandler handler) {
            return req -> handler.handle(this.handle(req));
        }
    }
    /**
